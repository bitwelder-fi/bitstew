...
#ifndef STEW_DETAIL_PACKAGED_ARGUMENTS_HPP
...
struct PackToTuple
{
    ...
    static auto convert(const ArgPack& arguments)
    {
        ...
        {
            using ArgType = typename function_traits<Function>::signature::template get<Index - 1>::type;
...
struct enableRepack
{
    ...
    static constexpr bool packSelf = is_base_arg_of<ObjectExtension*, Function, 0u>::value;

...
#ifndef STEW_PACKAGED_ARGUMENTS_HPP
...
struct STEW_API PackagedArguments
{
...
STEW_API bool operator==(const PackagedArguments& lhs, const PackagedArguments& rhs);
STEW_API bool operator!=(const PackagedArguments& lhs, const PackagedArguments& rhs);
...
{
    constexpr auto N = function_traits<FunctionSignature>::signature::arity;
    return detail::PackToTuple<FunctionSignature, PackagedArguments>::template convert<N, N>(*this);
}

} // namespace stew

#endif // STEW_PACKAGED_ARGUMENTS_HPP

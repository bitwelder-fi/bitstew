...
#ifndef STEW_TRACE_HPP
#define STEW_TRACE_HPP
...
/// trace record.
class STEW_API PrinterDecoratorInterface
{
public:
    /// Destructor.
...
/// Trace manager.
class STEW_API Tracer : public Job
{
public:

    struct STEW_API Diagnostics
    {
...
class STEW_API LogLine : protected TraceRecord
{
public:
...
class STEW_API PrinterFormatter : public TracePrinter, public PrinterDecoratorInterface
{
...
class STEW_API LogLevelDecorator : public PrinterFormatter
{
public:
    /// Constructor.
...
class STEW_API ThreadIdDecorator : public PrinterFormatter
{
public:
...
class STEW_API FunctionDecorator : public PrinterFormatter
{
public:
...
class STEW_API FileLineDecorator : public PrinterFormatter
{
...
class STEW_API MessageSeparator : public PrinterFormatter
{
public:
...
#define _STEW_CORE_TRACE(tracer, logLevel) \
stew::LogLine(tracer, logLevel, __FUNCTION__, __FILE__, __LINE__)()

#define _STEW_GLOBAL_TRACE(logLevel) \
stew::LogLine(logLevel, __FUNCTION__, __FILE__, __LINE__)()

#define STEW_LOG_FATAL(text) _STEW_GLOBAL_TRACE(stew::LogLevel::Fatal) << text
#define STEW_LOG_ERROR(text) _STEW_GLOBAL_TRACE(stew::LogLevel::Error) << text
#define STEW_LOG_WARNING(text) _STEW_GLOBAL_TRACE(stew::LogLevel::Warning) << text
#define STEW_LOG_INFO(text) _STEW_GLOBAL_TRACE(stew::LogLevel::Info) << text
#define STEW_LOG_DEBUG(text) _STEW_GLOBAL_TRACE(stew::LogLevel::Debug) << text
#else

#define STEW_LOG_FATAL(text)
#define STEW_LOG_ERROR(text)
#define STEW_LOG_WARNING(text)
#define STEW_LOG_INFO(text)
#define STEW_LOG_DEBUG(text)

#endif

#endif // STEW_TRACE_HPP

...
#ifndef STEW_TRACE_PRINTER_HPP
#define STEW_TRACE_PRINTER_HPP
...
/// Console output.
class STEW_API ConsoleOut : public TracePrinter
{
public:
    /// Constructor.

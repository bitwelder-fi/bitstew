...
class STEW_API Object : public MetaObject, public std::enable_shared_from_this<Object>
{
public:
    ...
    STEW_CLASS("stew.Object", Object, MetaObject)
    {
    };
...
///         - If the extension is found, and has no return value, returns an invalid Argument.
///         - If the extension is not found, returns nullopt.
STEW_API ReturnValue invoke(ObjectPtr object, std::string_view name, PackagedArguments arguments = PackagedArguments());

}

#endif // STEW_OBJECT_HPP

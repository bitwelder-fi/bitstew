...
#ifndef STEW_OBJECT_EXTENSION_HPP
#define STEW_OBJECT_EXTENSION_HPP
...
class STEW_API ObjectExtension : public MetaObject, public std::enable_shared_from_this<ObjectExtension>
{
public:
    /// Destructor.
    ...
    STEW_CLASS("stew.ObjectExtension", ObjectExtension, MetaObject)
    {
    };
...
#endif // STEW_OBJECT_EXTENSION_HPP

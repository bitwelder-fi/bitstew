...
class STEW_TEMPLATE_API MetaClassImpl : public MetaClass
{
...
protected:
    ...
    struct STEW_API MetaClassDescriptor : DescriptorInterface
    {
...
public:
    ...
    {
        static_assert(std::is_base_of_v<Registrars, MetaRegistrars>, "MetaRegistrars template argument must derive from stew::Registrars.");

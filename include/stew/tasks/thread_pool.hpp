...
#ifndef STEW_THREAD_POOL_HPP
#define STEW_THREAD_POOL_HPP
...
class STEW_API ThreadPool
{
public:
    /// The base of the jobs the thread pool handles;
    class STEW_API BaseJob : public std::enable_shared_from_this<BaseJob>
    {
...
void STEW_API yield(const std::chrono::nanoseconds& delay);


} // namespace stew

#endif // STEW_THREAD_POOL_HPP
